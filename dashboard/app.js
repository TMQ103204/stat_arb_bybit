/* ═══════════════════════════════════════════════════════════════════
   STAT-ARB DASHBOARD – Frontend Logic
   ═══════════════════════════════════════════════════════════════════ */
...
async function loadBacktest() {
  ...
  // Determine sym columns (first two non-empty columns)
...
async function stopExecution() {
  const res = await api('/api/execution/stop', { method: 'POST' });
